...
(function(ext) {
    ...
    ext.canSpeak = function() {
		return window.SpeechSynthesisUtterance !== undefined;
    };
	
    ext.speakText = function (text, callback) {
	...
	*/
    ...
    function deviceOpened(dev) {
        ...
        device.set_receive_handler('botTalk',processData);
    };
    ...
    var descriptor = {};
	ScratchExtensions.register('botTalk', descriptor, ext, {type: 'serial'});
})({});
